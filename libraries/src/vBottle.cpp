...
void vBottle::addEvent(vEvent &e) {
...
//void vBottle::getAll(eventdriven::vQueue &q)
//{
//    q.clear();

//    for(int i = 0; i < Bottle::size(); i+=2) {
//        vEvent * e = eventdriven::createEvent(Bottle::get(i).asString());
//        if(!e) {
...
//void vBottle::getAllSorted(eventdriven::vQueue &q)
//{
//    getAll(q);
//    q.sort();
