...
/**
 * @file eventDrivenModule.cpp
 * @brief Implementation of the eventDrivenModule (see header file).
 */

#include "iCub/eventDrivenModule.h"
...
bool eventDrivenModule::updateModule()
{
    return true;
}

double eventDrivenModule::getPeriod()
{
