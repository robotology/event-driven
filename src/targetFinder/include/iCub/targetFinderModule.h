...
/**
 * @file targetFinderModule.h
 * @brief A module that lauches the eventExtractorThread handling all the user commands
 */

#ifndef _TARGET_FINDER_MODULE_H_
#define _TARGET_FINDER_MODULE_H_

/** 
 *
 * \defgroup icub_targetFinder targetFinder
 * @ingroup icub_eMorph
 *
 *
 ...
 *
 * \c targetFinder.ini  in \c /eMorphApplication/conf \n
 * 
 ...
 * 
 * <tt>targetFinder --name /targetFinder --context logPolarAttentionSystem/conf --from targetFinder.ini --robot icub</tt>
 *
