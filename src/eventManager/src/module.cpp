...
bool Manager::updateModule()
{
    ...
    if (cmd != NULL)
    {
        ...
        case CMD_HELP: {
            ...
            reply.addString("kpl  (u v) - karmaPush using traditional camera and blob detector");
            reply.addString("sml  (u v) - karmaPush using traditional camera and blob detector + smoothPursuit");
