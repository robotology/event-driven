...
private:
    ...
    yarp::sig::Matrix *PrjLeftDVS, *PrjRightDVS;                                            // projection matrix for the left and right Dragon cameras
    yarp::sig::Matrix *PrjLeftDragon, *PrjRightDragon;                                            // projection matrix for the left and right DVS cameras
