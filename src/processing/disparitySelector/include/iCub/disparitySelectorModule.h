...
/**
 * @file disparitySelectorModule.h
 * @brief Simple module that implements creation of disparitySelector (larger image) from original camera image
 */
...
/** 
 *
 * \defgroup icub_disparitySelector disparitySelector
 ...
 *
 * - \c from \c disparitySelector.ini \n 
 *   specifies the configuration file
 *
 * - \c context \c disparitySelector/conf \n
 *   specifies the sub-path from \c $ICUB_ROOT/icub/app to the configuration file
 *
 * - \c name \c disparitySelector \n 
 *   specifies the name of the disparitySelector (used to form the stem of disparitySelector port names)  
 *
 * - \c robot \c icub \n 
...
class disparitySelectorModule:public yarp::os::RFModule {
    int width_orig, height_orig;             // dimension of the input image
    int width, height;                       // dimension of the disparitySelector image
    ...
    /*  */
    disparitySelectorThread *edThread;             // pointer to a new thread to be created and started in configure() and stopped in close()

public:
    /**
    *  configure all the disparitySelector parameters and return true if successful
    ...
    */
    ...
    /**
    *  close and shut down the disparitySelector
    */
    bool close();
