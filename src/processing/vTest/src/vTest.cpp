...
/**********************************************************/
bool vTestModule::configure(yarp::os::ResourceFinder &rf)
{
...
/**********************************************************/
bool vTestModule::interruptModule()
{
    rpcPort.interrupt();
...
/**********************************************************/
bool vTestModule::updateModule()
{
    return true;
}

/**********************************************************/
double vTestModule::getPeriod()
{
    return 0.1;
}

bool vTestModule::respond(const yarp::os::Bottle &command,
