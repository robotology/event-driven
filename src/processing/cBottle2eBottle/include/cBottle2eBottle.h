...
*/
//class EventToBottleHandler : public yarp::os::BufferedPort<eBottle>
//{
//private:
...
*/
class C2EHandler : public yarp::os::BufferedPort<yarp::os::Bottle>
{
private:
...
public:
     ...
     * @param moduleName is passed to the thread in order to initialise all the ports correctly (default yuvProc)
     */
    C2EHandler( const std::string &moduleName );
    ~C2EHandler();
...
class cBottle2eBottle:public yarp::os::RFModule
{
    /* module parameters */
