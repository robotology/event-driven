...
#define REQUIRED_CORNERS_COUNT 20 // product of height and width
...
private:
    ...
    IplImage* centroidImage, *out, *now;
    IplImage* mapx, *mapy;
...
public:
    ...
    */
    void getCalibrationParameters(int camera);
    ...
    */
    ...
    void prepareTheData(IplImage* typicalImage);
