...
#ifndef _LP_REMAPPER_MODULE_H_
#define _LP_REMAPPER_MODULE_H_
 ...
 *    The port can be used by other modules but also interactively by a user through the yarp rpc directive, viz.: \c yarp \c rpc \c /logpolarRemapper
 *    This opens a connection from a terminal to the port and allows the user to then type in commands and receive replies.
 *       
 *  - \c /logpolarRemapper/image:i \n
 *
 * <b>Output ports</b>
 *
 *  - \c /logpolarRemapper \n
 ...
 *
 * \c logpolarRemapper.ini  in \c $ICUB_ROOT/app/logpolarRemapper/conf \n
 * 
 ...
 * 
 * <tt>logpolarRemapper --name logpolarRemapper --context logpolarRemapper/conf --from logpolarRemapper.ini --robot icub</tt>
 *
 * \author Rea Francesco
 *
 * Copyright (C) 2010 RobotCub Consortium\n
 * CopyPolicy: Released under the terms of the GNU GPL v2.0.\n
 * This file can be edited at \c $ICUB_ROOT/main/src/modules/logpolarRemapper/include/iCub/cfCollectorModule.h
 * 
 */
...
class lpRemapperModule:public yarp::os::RFModule {
    ...
    lpRemapperThread* lprThread;                //cfCollectorThread for processing events
...
#endif // __LP_REMAPPER_MODULE_H__
