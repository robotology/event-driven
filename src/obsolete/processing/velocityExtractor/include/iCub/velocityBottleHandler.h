...
/**
 * @file velocityBottleHandler.h
 * @brief A class inherited from the bufferefPort class created in order to read packets of velocity information
 */

#ifndef _VELOCITY_BOTTLE_HANDLER_H
#define _VELOCITY_BOTTLE_HANDLER_H
...
class velocityBottleHandler:public yarp::os::BufferedPort<VelocityBuffer> {
public:
    /**
     * constructur
     */
    velocityBottleHandler();
    /**
     * destructur
     */
    ~velocityBottleHandler();
    ...
    */
    virtual void onRead(VelocityBuffer& b);
    ...
    */
    ...
    /**
     * @brief function that extract one of the velocityBuffer from the buffer
     * @param receivedBottle single velocity buffer point
     */
    VelocityBuffer* extractBottle(VelocityBuffer* receivedBottle);
...
private:
    ...
    yarp::os::Bottle* receivedVelocity;                           // pointer to the received bottle
    VelocityBuffer** bufferVelocity;                            // buffer of received velocitu
...
#endif //_VELOCITY_BOTTLE_HANDLER_H
