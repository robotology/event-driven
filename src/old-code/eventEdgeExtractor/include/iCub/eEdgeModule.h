...
/**
 * @file eEdgeModule.h
 * @brief A module that reads the images from different dvs cameras and extracts edges from both of them
 */

#ifndef _EE_EXTRACTOR_MODULE_H_
#define _EE_EXTRACTOR_MODULE_H_

/** 
 *
 * \defgroup icub_eEdgeExtractor eEdgeExtractor
 * @ingroup icub_eMorph
 *
 *
...
/**
* CHANGE LOG
* 09/02/2011 : created the module                                                                       @author Rea
*/
...
class eEdgeModule:public yarp::os::RFModule {
    ...
    eEdgeThread* eeThread;                   //visualAlignerThread for processing events
...
#endif // _EE_EXTRACTOR_MODULE_H__
