...
#ifndef _LP_REMAPPER_THREAD_H_
#define _LP_REMAPPER_THREAD_H_
...
class lpRemapperThread : public yarp::os::RateThread {
private:
    ...
    logpolarRemapper* lpRemapper; //receives real-time events
public:
    /**
    * default constructor
    */
